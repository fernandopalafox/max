...
Also includes a pursuit-evasion task.
"""
...
def make_env(params: EnvParams):
    ...
    def _step_dynamics(
        ...
        """
        Double integrator dynamics, closing over dt, num_agents, and max_speeds.
        """
        goal = state[-2:]
...
def make_pursuit_evasion_env(params: EnvParams):
    ...
    - Agent 1 (Evader) tries to reach the goal while avoiding the pursuer.
    """
